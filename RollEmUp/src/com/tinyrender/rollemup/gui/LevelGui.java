...
public class LevelGui extends Gui {
    ...
    public LevelGui() {
    	...
    	paused.setPosition(RollEmUp.SCREEN_HALF_WIDTH-paused.button.bounds.width/2.0f, RollEmUp.SCREEN_HALF_HEIGHT+150.0f);
    	
    	quit = new Label(Assets.droidsans, "Quit");
    	quit.setPosition(RollEmUp.SCREEN_HALF_WIDTH-quit.button.bounds.width/2.0f, RollEmUp.SCREEN_HALF_HEIGHT+80.0f);
    }
