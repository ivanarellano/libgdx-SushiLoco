...
public class SoySauce implements ObjectFactory {
	...
	public GameObject build(float x, float y, World world) {
		...
		int largestDimension = soyObj.objectRepresentation.getLargestDimension();
		
		soyObj.body = BodyFactory.createPoly(verts, x, y, largestDimension / 2.0f / Level.PTM_RATIO, 
										1.0f, BodyType.DynamicBody, soyObj.world);
