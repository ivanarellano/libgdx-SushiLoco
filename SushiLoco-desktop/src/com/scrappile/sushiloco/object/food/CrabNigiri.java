...
public class CrabNigiri implements ObjectFactory {
	...
	public TextureRegion texture = Assets.atlas.findRegion("crabnigiri");
	...
	public GameObject build(float screenPosX, float screenPosY) {
		...
		screenPosY += crabNigiri.objRep.halfHeight / Level.PTM_RATIO;
				
		crabNigiri.body = BodyFactory.createPoly(verts, screenPosX, screenPosY,
				1.1f, 1.2f, BodyType.DynamicBody, crabNigiri);
