...
public class ParallaxLayer {
	...
	/**
	* @param region			TextureRegion to draw, this can be any width/height
	* @param parallaxRatio	Relative speed of x,y {@link ParallaxBackground#ParallaxBackground(ParallaxLayer[], float, float, Vector2)}
	* @param startPosition	Start position of x,y
	* @param padding		Padding of the region at x,y
	*/
