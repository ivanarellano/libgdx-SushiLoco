...
public class SushiLoco extends Game implements ApplicationListener {
	...
	public void render() {
		...
		if (finishedLoading) {
			...
			fpsLayout.setText(Assets.droidSansFont, fps);

			Assets.batch.getProjectionMatrix().setToOrtho2D(0.0f, 0.0f, SushiLoco.SCREEN_WIDTH, SushiLoco.SCREEN_HEIGHT);
			Assets.batch.begin();

			Assets.droidSansFont.draw(Assets.batch, fps, SushiLoco.SCREEN_WIDTH - fpsLayout.width - 20.0f, fpsLayout.height + 20.0f);
