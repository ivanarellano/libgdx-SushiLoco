...
public class EggNigiri implements ObjectFactory {
	...
	private TextureRegion texture = Assets.atlas.findRegion("eggnigiri");
	...
	public GameObject build(float screenPosX, float screenPosY) {
		...
		screenPosY += eggNigiri.objRep.getHalfHeight() / Level.PTM_RATIO;
				
		eggNigiri.body = BodyFactory.createPoly(verts, screenPosX, screenPosY, 1.1f, 1.2f, BodyType.DynamicBody, eggNigiri);
