...
public class TunaNigiri implements ObjectFactory {
	...
	private TextureRegion texture = Assets.atlas.findRegion("tunanigiri");
	...
	public GameObject build(float screenPosX, float screenPosY) {
		...
		screenPosY += tunaNigiri.objRep.getHalfHeight() / Level.PTM_RATIO;
				
		tunaNigiri.body = BodyFactory.createPoly(verts, screenPosX, screenPosY, 1.1f, 1.2f, BodyType.DynamicBody, tunaNigiri);
